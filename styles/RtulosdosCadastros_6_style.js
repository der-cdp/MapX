...
var style_RtulosdosCadastros_6 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("Código do Documento") !== null && resolution > 0 && resolution < 8) {
            labelText = String(feature.get("Código do Documento"));
        }
