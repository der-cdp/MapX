...
var format_Empreendimentos_7 = new ol.format.GeoJSON();
var features_Empreendimentos_7 = format_Empreendimentos_7.readFeatures(json_Empreendimentos_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Empreendimentos_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Empreendimentos_7.addFeatures(features_Empreendimentos_7);
var lyr_Empreendimentos_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Empreendimentos_7, 
                style: style_Empreendimentos_7,
                popuplayertitle: 'Empreendimentos',
                interactive: false,
                title: 'Empreendimentos'
            });
var group_SCDES = new ol.layer.Group({
                                layers: [lyr_FaixadeDomnio_4,lyr_reasDesapropriadas_5,lyr_RtulosdosCadastros_6,lyr_Empreendimentos_7,],
                                fold: 'open',
                                title: 'SCDES'});
...
lyr_Empreendimentos_7.set('fieldAliases', {'fid': 'fid', 'Nome': 'Nome', });
...
lyr_Empreendimentos_7.set('fieldImages', {'fid': 'TextEdit', 'Nome': 'TextEdit', });
...
lyr_Empreendimentos_7.set('fieldLabels', {'fid': 'no label', 'Nome': 'no label', });
lyr_Empreendimentos_7.on('precompose', function(evt) {
